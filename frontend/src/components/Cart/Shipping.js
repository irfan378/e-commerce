        ...
        <div className="shippingContainer">
            <div className="shippingBox">
                ...
                <form className='shippingForm' encType='multipart/form-data' onSubmit={shippingSubmit}>
                    ...
                    <div>
                        <PhoneIcon />
                        <input type="number" placeholder='Phone Number' required value={phoneInfo} onChange={(e) => setPhoneInfo(e.target.value)} size="10" />
                    </div>
                    <div>
                        <PublicIcon />
                    ...
                    <input type="submit" value="Continue" className="shippingInfo" disabled={state ? false : true} />
                </form>
            </div>
        </div>
    </Fragment>
